...
class LoadReviewCommentEditsTaskTestCase(unittest.TestCase):
    """ Tests the loading of edits into the pull request review comments documents into the mongo database """
    ...
    def test_record_in_database(self):
        ...
        result = luigi.build([pull_request_review_comment.LoadReviewCommentsTask(owner='Netflix', name='pollyjs')],
                             local_scheduler=True, detailed_summary=True)
