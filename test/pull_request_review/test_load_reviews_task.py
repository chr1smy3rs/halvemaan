...
class LoadReviewsTaskTestCase(unittest.TestCase):
    ...
    def test_no_record_in_database(self):
        ...
        result = luigi.build([pull_request_review.LoadReviewsTask(owner='google', name='cloud-forensics-utils')],
        ...
        self.assertEqual(LoadReviewsTaskTestCase._get_actual_comments(case_setup),
                         LoadReviewsTaskTestCase._get_expected_comments(case_setup))
